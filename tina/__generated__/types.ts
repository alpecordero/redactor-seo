...
export type HomepageCtaSection = {
  ...
  title: Scalars['String']['output'];
  description: Scalars['String']['output'];
  secondaryDescription: Scalars['String']['output'];
